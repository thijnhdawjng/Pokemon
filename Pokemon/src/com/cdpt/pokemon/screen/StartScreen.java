...
public class StartScreen extends Game implements Screen, InputProcessor {
    ...
    public StartScreen(Pokemon app){
        skin = new Skin(Gdx.files.internal("res/ui/uiskin.json"));
        stage = new Stage(new ScreenViewport());
        table = new Table();
        batch = new SpriteBatch();
        sprite = new Sprite(new Texture(Gdx.files.internal("res/ui/startscreen.jpg")));
